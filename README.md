# SQL injection in Rust with Actix-Web 🦀
...
```bash
cargo run
# You should see the message: 🚀 Server started successfully at http://127.0.0.1:8080
```

💥 Demonstrating the Vulnerability (/vulnerable/login)
...
🛡️ Demonstrating the Mitigation (/secure/login)
